...
namespace KinematicCharacterController.Examples
{
    ...
    public class ExampleCharacterController : BaseCharacterController
    {
        ...
        public Vector3 viewCurrentVelocity;
        public float blendSmooth;

        [Header("Air Movement")]
        public float MaxAirMoveSpeed = 10f;
        public float AirAccelerationSpeed = 2f;
        ...
        public float axisYAnim;
        public float axisHAnim;
        ...
        public void Update()
        {
            ...
            if (viewCurrentVelocity == Vector3.zero)
            {
                idlePlus++;
            }
                ...
                case CharacterState.Default:
                    {
                        ...
                        viewCurrentVelocity = currentVelocity;
                        // Ground movement
                        ...
                        anim.SetFloat("vertical", /*currentVelocity.z*/axisYAnim, blendSmooth, deltaTime);
                        anim.SetFloat("horizontal", /*currentVelocity.z*/axisHAnim, blendSmooth, deltaTime);
        ...
        public bool OnGround()
        {
            ...
            //r = true;
            if (Physics.Raycast(origin, dir, out hit, dis, Motor.CollidableLayers))
            {
                r = true;
            }
        ...
        public IEnumerator Sprint()
        {
            ...
            AirAccelerationSpeed = 6f;
            MaxAirMoveSpeed = 15;
            JumpSpeed = 15;
            yield return new WaitForSeconds(3f);
            MaxStableMoveSpeed = 5;
            AirAccelerationSpeed = 2f;
            MaxAirMoveSpeed = 10;
            JumpSpeed = 10;
        }
        ...
        /* void OnCollisionEnter(Collision col)
         {
             ...
             if (col.gameObject.tag == "DeathZonePre")
             {
                 //sinked = true;
